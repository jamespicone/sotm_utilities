...
{
    public class VillainCardInsistsItsHeroCardController : CardController
    {
        public VillainCardInsistsItsHeroCardController(Card card, TurnTakerController controller) : base(card, controller)
        {
