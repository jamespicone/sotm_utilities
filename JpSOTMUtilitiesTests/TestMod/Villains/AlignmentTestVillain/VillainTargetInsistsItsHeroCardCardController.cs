...
{
    public class VillainTargetInsistsItsHeroCardCardController : CardController
    {
        public VillainTargetInsistsItsHeroCardCardController(Card card, TurnTakerController controller) : base(card, controller)
        {
