...
{
    public class HeroCardInsistsItsVillainCardController : CardController
    {
        public HeroCardInsistsItsVillainCardController(Card card, TurnTakerController controller) : base(card, controller)
        {
