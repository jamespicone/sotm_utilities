...
{
    public class HeroTargetInsistsItsVillainTargetCardController : CardController
    {
        public HeroTargetInsistsItsVillainTargetCardController(Card card, TurnTakerController controller) : base(card, controller)
        {
